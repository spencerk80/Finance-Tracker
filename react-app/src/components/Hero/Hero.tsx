...
const Hero = () => {
  return (
    <section className="w-screen border-b border-brand-light">
      <div className="container m-auto flex flex-col md:flex-row max-w-1/2 items-center justify-center py-8">
        <div className="w-full h-full lg:w-1/2 lg:py-6 flex flex-col justify-between items-center text-center p-4">
          ...
          <button className="bg-white hover:bg-brand text-brand font-semibold hover:text-white py-2 px-4 border border-brand hover:border-transparent w-1/2">
            Get Started
          </button>
        </div>
